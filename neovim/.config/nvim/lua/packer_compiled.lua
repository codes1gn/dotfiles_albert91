...
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'FixCursorHold.nvim', 'null-ls.nvim', 'cinnamon.nvim', 'nvim-colorizer.lua', 'nvim-treesitter'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'nvim-web-devicons', 'nvim-notify'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'FixCursorHold.nvim', 'null-ls.nvim', 'cinnamon.nvim', 'nvim-colorizer.lua', 'indent-o-matic', 'nvim-treesitter', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
